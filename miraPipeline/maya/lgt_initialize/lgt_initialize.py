...
from miraLibs.pipeLibs.pipeMaya.lgt import replace_env, import_cloth, import_hair_cache, import_vfx_cache
...
class LgtInit(QDialog):
    ...
    def setup_ui(self):
        ...
        self.import_vfx_btn = QPushButton(u"导入场景特效")
        label = QLabel()
        ...
        main_layout.addWidget(self.import_vfx_btn)
    ...
    def set_signals(self):
        ...
        self.import_vfx_btn.clicked.connect(import_vfx_cache.main)
